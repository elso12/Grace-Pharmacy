  ...
  try {
    ...
    const sales = [
      ...
      },
      {
        ...
        walletProvider: 'BOA',
        walletPhone: '+251911000001',
        transactionReference: 'BOA-332110',
        status: 'COMPLETED',
        createdAt: now,
        updatedAt: now
      },
      {
        ...
        items: [
          { product: productIds[2], productName: 'Ventolin HFA Inhaler', quantity: 1, unitPrice: 42.5, lineTotal: 42.5 },
          { product: productIds[16], productName: 'Vitamin D3 5000 IU High Potency', quantity: 1, unitPrice: 10.50, lineTotal: 10.50 }
        ],
        subtotal: 53.0,
        taxAmount: 4.24,
        totalAmount: 57.24,
        ...
        walletPhone: '+251911234567',
        transactionReference: 'TLB-992140',
        status: 'COMPLETED',
        createdAt: daysAgo(1),
        updatedAt: daysAgo(1)
      },
      {
        ...
        amountPaid: 36.72,
        paymentMethod: 'MOBILE_WALLET',
        walletProvider: 'CBE_BIRR',
        walletPhone: '+251922334455',
        transactionReference: 'CBE-440192',
        status: 'COMPLETED',
        createdAt: now,
        updatedAt: now
      },
